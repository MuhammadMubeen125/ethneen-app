        ...
        <div className="oneDiv">
          <div className="flex flex-col items-start justify-between gap-[20px] w-full px-8 py-6 lg:py-8">
            <Image
              src={LogoEthneen}
              alt="Logo"
              className="w-[142px] h-[32px]"
            />
            <div className="flex md:hidden items-center">
              <Image
                src={FileNav}
                alt="Logo"
                className="w-[50px] h-[50px] font-bold flex md:hidden"
              />
              <Image
                src={Connector}
                alt="Logo"
                className="w-[40px] h-[50px] font-bold flex md:hidden"
              />
              <Image
                src={GalleryNav}
                alt="Logo"
                className="w-[50px] h-[50px] opacity-[0.5] flex md:hidden"
              />
              <Image
                src={Connector}
                alt="Logo"
          ...
          >
            <div className="flex items-start gap-4 ">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Add title and description to your project
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 opacity-60">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Add what you offer and your charges
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="ContainerSectionTwo flex md:p-[32px] p-[20px] flex-col items-center gap-[32px] self-stretch">
          <div className="formmainDiv flex flex-col sm:w-full md:w-[576px] items-start gap-[32px]">
            ...
            <div className="inputDiv flex flex-col items-start gap-[6px] self-stretch">
              ...
              <input
                type="text"
                placeholder="What are you offering to clients?"
                name=""
                id=""
            ...
            <div className="inputDiv flex flex-col items-start gap-[6px] self-stretch">
              ...
              <textarea
                ...
                rows="3"
                cols="3"
                className="inputSelect w-full h-[86px]"
              ></textarea>
            </div>
            ...
            <div className="inputDiv flex flex-col items-start gap-[6px] self-stretch">
              <div className="flex justify-between items-center self-stretch">
                <label htmlFor="Category">
                  Meta Title - ideal length is 50–60 characters (optional)
                </label>
